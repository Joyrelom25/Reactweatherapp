    ...
    render() {
        ...
        return(
         <div className = "weather__info"> 
            ...
            {this.props.temperature &&  <p className= "weather__key"> Temperature : {this.props.temperature}&deg; </p> }
            {this.props.description &&  <p className= "weather__key">  Description : {this.props.description} </p> }
            {this.props.tempmax && <p className= "weather__key"> Temp max : {this.props.tempmax}&deg; </p>}
            {this.props.tempmin && <p className= "weather__key" > Temp min : {this.props.tempmin}&deg; </p>}
